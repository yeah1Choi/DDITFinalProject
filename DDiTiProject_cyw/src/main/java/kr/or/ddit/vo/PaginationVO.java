...
public class PaginationVO<T> {
	...
	private int mainscreenSize = 7;  // 페이지 당 게시글 수(메인에 보여지는)
	...
	public String getPagingHTML() {
		...
		html.append("<ul class='pagination' style='--bs-pagination-active-bg: #0052cc !important; --bs-pagination-active-border-color: #0052cc !important;'>");
