    ...
    <div class="page" >
      <div class="box" >
        ...
        <div class="userData">
          ...
          <p>
            <span class="userTitle"><span>생년</span><span>년월일</span></span> :
            <span>${member.memBir }</span>
          </p>
          <p>
            <span class="userTitle"><span>졸업</span><span>년월일</span></span>
            		<span> ${member.studentInfoVO.memGrdDate }</span>
          </p>
        </div>
        <table>
          <thead>
          ...
          <tr>
			...
			<td>
				${member.departmentVO.dprtName } 
			</td>
            <td>${member.studentInfoVO.memRegDate }</td> <!--입학일  -->
            <td> ${member.studentInfoVO.memGrdDate }</td> <!--졸업일  -->
          </tr>
        </table>
