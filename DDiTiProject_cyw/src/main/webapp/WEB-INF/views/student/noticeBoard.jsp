								...
								<table class="table mb-0" style="text-align: center">
									<thead class="bg-primary">
										<tr>
											<th scope="col">순번</th>
											<th scope="col ">제목</th>
<!-- 											<th scope="col" class="listCont">내용</th>
											...
											<c:otherwise>
												...
												<c:forEach items="${planList }" var="planBoard">
													<tr>
														...
														<td class="text-start"><a href="/DYUniv/noticeBoardDetail.do/${planBoard.brdNo }">${planBoard.brdTitle }</a></td>
<%-- 														<td>${planBoard.brdCont }</td>
