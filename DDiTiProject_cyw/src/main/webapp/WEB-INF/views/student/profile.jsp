...
<form action="/DYUniv/updProfile.do" method="post" id="proUpdateForm" enctype="multipart/form-data">
	...
	<div class="widget-user-image col-2">
		<c:if test="${empty stdmember.memProfile }">
	    ...
	    <c:if test="${!empty stdmember.memProfile }">
	      <img class="border-radius" src="${pageContext.request.contextPath }/resources/files${stdmember.memProfile }"
	      	name="memProfile" alt="User Avatar" style="width: 220px;">
		</c:if>
	   <br>     
    ...
    <div class="col-5">
        ...
        <div class="form-group row">
          <label for="example-text-input" class="col-sm-3 col-form-label">학번</label>
          <div class="col-sm-5">
            <input class="form-control" type="text" value="${stdmember.memId }"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input class="form-control" type="text" value="${stdmember.memBir }"
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-5">
                  <input class="form-control" type="text" value="${stdmember.memNationCode }" 
    ...
    <div class="col-5">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
            <c:set var="gender" />
            <c:if test="${stdmember.memGen eq 'M' }">
            	<c:set value="남자" var="gender"/>
            </c:if>
            <c:if test="${stdmember.memGen eq 'F' }">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-5">
            <input class="form-control" type="email" value="${stdmember.memEmail }" 
         ...
         <!-- 이메일 -->
	        ...
	        <div class="form-group row">
	            ...
	            <div class="col-sm-5">
	                <input class="form-control" type="text" value="${stdmember.memPostcode }" 
	        ...
	        <div class="form-group row">
	            ...
	            <div class="col-sm-5">
	                <input class="form-control" type="text" value="${stdmember.memAddr1 }" 
	        ...
	        <div class="form-group row">
	            ...
	            <div class="col-sm-5">
	                <input class="form-control" type="text" value="${stdmember.memAddr2 }" 
			...
			<div class="form-group row">
			  ...
			  <div class="col-sm-5">
			    <input class="form-control" type="tel" value="${stdmember.memPh }" 
			    	name="memPh" id="memPh">
			  </div>
			</div>
	  		<!-- 폰번호 -->
	...
	<div class="col-sm-10 col-md-2"
		style="float: right;">
		<button type="button" id="updBtn" class="waves-effect waves-light btn btn-primary mb-5">수정하기</button>
	</div>
  <h4 class="box-title mt-40">학적 정보</h4>
  <div class="table-responsive">
    <table class="table">
        <tbody>
            <tr>
                <td width="390">학적 상태</td>
                <td>
                <%-- ${stdmember.studentInfo.memStatusCode }  --%>
                  <c:set var="memStatus"/>
		          <c:if test="${stdmember.studentInfo.memStatusCode eq 'MEM001' }">
		          	<c:set var="memStatus" value="재학"/>
		          </c:if>
		          <c:if test="${stdmember.studentInfo.memStatusCode eq 'MEM002' }">
		          	<c:set var="memStatus" value="휴학"/>
		          </c:if>
		          <c:if test="${stdmember.studentInfo.memStatusCode eq 'MEM003' }">
		          	<c:set var="memStatus" value="제적"/>
		          </c:if>
		          <c:if test="${stdmember.studentInfo.memStatusCode eq 'MEM004' }">
		          	<c:set var="memStatus" value="졸업"/>
		          </c:if>
		          <c:if test="${stdmember.studentInfo.memStatusCode eq 'MEM005' }">
		          	<c:set var="memStatus" value="수료"/>
		          </c:if>
		          ${memStatus }
                </td>
            </tr>
            ...
            <td>입학일</td>
            	<td>
                	${fn:substring(stdmember.studentInfo.memRegDate,0,10) }
             	</td>
            </tr>
            <tr>
                <td>졸업일</td>
                <td>${fn:substring(stdmember.studentInfo.memGrdDate,0,10) }</td>
