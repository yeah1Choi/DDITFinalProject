	...
	<section class="content">
		...
		<div class="row boxParent">
			...
			<div class="box" style="width: 33%">
				...
				<div class="box-body" style="padding: 0 1.5rem;">
						...
						<table class="table mb-0">
							<tbody id="cnslInfo" idx="${counselVO.cnslNo }">
								...
								<tr>
									...
									<td colspan="3"><textarea id="cnslDetail form-control" style="width: 100%; height: 185px; overflow: hidden; padding: 0.5rem;"></textarea></td>
								</tr>
							</tbody>
						</table>
					</div>
