				...
				<div class="d-inline-block align-items-center">
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">학생 계정 생성</li>
						</ol>
					</nav>
				</div>
			</div>		
	 ...
	 <!-- Step wizard -->
	  <div class="box">
		<div class="box-body wizard-content">
			<form action="/DYUniv/employer/createStuID.do" class="tab-wizard wizard-circle" id="createIDForm" method="post">
					...
					<div class="col-md-4">
						<div class="box box-widget widget-user">
							...
							<div class="widget-user-image">
							  <img class="rounded-circle preview" src="${pageContext.request.contextPath}/resources/images/user3-128x128.jpg" alt="User Avatar">
							</div>
							...
							<div class="form-group">
								<div class="row">
									<div class="col-6">
										...
										<input type="date" class="form-control" id="joinDate" name="memRegDate"/>
									</div>
								</div>
							</div>
						</div>
